...
export default function ArtikelPage() {
  ...
  return (
    <>
      <title>Artikel | Pojok Statistik</title>
        ...
        <div className=" bg-white text-white py-16 px-4 border-b-2 border-gray-100">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <h1 className="text-4xl text-gray-900 md:text-5xl font-extrabold mb-4">
              Artikel &{" "}
              <span className="text-purple-800">Kajian Statistik</span>
            </h1>
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">
              Kumpulan tulisan analitis, ringkasan eksekutif, dan catatan
              lapangan yang mendokumentasikan wawasan data Papua Barat.
            </p>
          </div>
        </div>
